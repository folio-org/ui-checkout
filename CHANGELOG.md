...
## [4.0.3](https://github.com/folio-org/ui-checkout/tree/v4.0.3) (2020-09-10)
[Full Changelog](https://github.com/folio-org/ui-checkout/compare/v4.0.2...v4.0.3)

* Pass proxy details to checkout endpoint _only_ when user is acting as a proxy. Fixes UICHKOUT-644.
