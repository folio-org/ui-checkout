...
class PatronForm extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (!this.barcodeEl || !this.barcodeEl.current) return;
    const input = this.barcodeEl.current.getRenderedComponent().refs.wrappedInstance.input;
    if (document.activeElement !== input && !nextProps.patron.id && nextProps.submitFailed) {
