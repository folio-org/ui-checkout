...
class ViewPatron extends React.Component {
  ...
  render() {
    ...
    const patronDetail = (
      <div>
        <br />
        <this.connectedUserDetail dataKey="sponsor" id="patron-detail" label="Patron" user={patron} {...this.props} />
    ...
    const proxyDetail = (
      <div>
        <br />
        <this.connectedUserDetail dataKey="proxy" id="proxy-detail" label="Proxy" user={proxy} {...this.props} />
        <div className={css.section}>
          <Row>
            <Col xs={4}>
