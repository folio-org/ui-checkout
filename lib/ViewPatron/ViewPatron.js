...
class ViewPatron extends React.Component {
  ...
  render() {
    ...
    const patronDetail = (
      <div>
        <br />
        <this.connectedPatronDetail id="patron-detail" label="Borrower" user={patron} {...this.props} />
    ...
    const proxyDetail = (
      <div>
        <br />
        <this.connectedProxyDetail id="proxy-detail" label="Borrower's proxy" user={proxy} {...this.props} />
        <div className={css.section}>
          <Row>
            <Col xs={4}>
